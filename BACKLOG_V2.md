...
### Actualización 24/06/2026 – Cierre de sesión y revisión del Manual del Arquitecto

**Deuda técnica registrada:**
- **[BAJA] B150** – Implementar generación de `TraceID` único por petición en el frontend y propagarlo a las transacciones de Firestore para trazabilidad completa (Sección IV del Manual del Arquitecto).
---
---
### Actualización 24/06/2026 – Auditoría de Arquitectura y Cierre de Sesión

**Deuda técnica registrada:**
- **[BAJA] B150** – Implementar generación de TraceID único por petición en el frontend y propagarlo a las transacciones de Firestore para trazabilidad completa (Sección IV del Manual del Arquitecto).
- **[MEDIA] B151** – Alinear la estructura de directorios al Mapa Físico canónico del Manual del Arquitecto (Sección II). Actualmente no existen las carpetas `routes/`, `controllers/`, `repositories/`, `schemas/` (por módulo) y `tests/`.
- **[MEDIA] B152** – Migración progresiva a la estructura híbrida (Manual adaptado a React + Firebase) descrita en la sesión del 24/06/2026. Incluye mover esquemas a cada módulo, crear `routes/` modularizadas y renombrar vistas como controladores.
---
### Actualizaci�n 24/06/2026 � Auditor�a de Endurecimiento y SRE

**Deuda t�cnica registrada:**
- **[BAJA] B150** � Implementar generaci�n de TraceID �nico por petici�n en el frontend y propagarlo a las transacciones de Firestore (Secci�n IV del Manual).
- **[MEDIA] B153** � Implementar pruebas unitarias en el m�dulo inscripcion (carpeta 	ests/). Actualmente no existen pruebas de caja negra para los flujos HTTP 200, 400 y 409.
- **[BAJA]** � Agregar capitalizaci�n autom�tica (trim + capitalizar) en el campo Nombre del paso 1 (Secci�n III.2).
- **[BAJA]** � Evaluar implementaci�n de Rate Limiting si se migra al plan Blaze de Firebase (Secci�n III.3).
