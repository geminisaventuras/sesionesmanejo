// @build: 2026-06-24 | id: INSC-REFACTOR-FINAL | backup: InscripcionView.jsx.backup-20260623-231934 | desc: Lógica de disponibilidad integrada, eliminados servicios y hooks externos
...
export const InscripcionView = () => {
  ...
  const handleConfirmarPago = useCallback(async () => {
    ...
    const result = await ReservaService.crearReserva({
      ...form, userId: ctx.fbUser.uid, fecha: form.fecha1, fecha2: disponibilidad?.fecha2Calc || '',
  ...
  }, [lockId, form, ctx.fbUser, disponibilidad, fechaNacimiento, baseUSD, precioFinalVES, limpiarSesion, showToast, generatedPin]);
  ...
  const handleSelectHorario = useCallback(async (bloque) => {
    ...
    // Recalcular recursos JIT con la misma función pura
