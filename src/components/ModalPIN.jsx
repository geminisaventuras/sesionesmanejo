    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 transform transition-all">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-black text-gray-900 mb-2">Formulario Enviado</h2>
          <p className="text-sm text-gray-500 mb-4">Tu código de acceso ha sido generado. Guárdalo bien.</p>
