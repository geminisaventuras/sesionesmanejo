// @build: 2026-08-28.14-40-00 | id: BXX-BYY | backup: AdminReservasHome.jsx.backup-20260828-144000 | desc: Añade sección Hoy y En curso a la home de reservas
...
const AdminReservasHome = () => {
  const { reservas, horarios, user, logoutUser } = useContext(AppContext);
  const navigate = useNavigate();
  const res = reservas || [];

  // Tick para actualizar "EN CURSO"
