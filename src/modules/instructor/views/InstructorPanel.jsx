// @build: 2026-06-22 | id: INSTRUCTOR-HEADER-DINAMICO | desc: Header dinámico con botón volver en vista pendientes, tarjetas con verificación de pago
...
export default function InstructorPanel() {
  ...
  // Header dinámico: muestra botón volver + título en vista "pendientes", nombre en resumen
  const header = (
    <DashboardHeader
